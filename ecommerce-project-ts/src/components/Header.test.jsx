...
describe('Header component', () => {
    ...
    it('displays the header correctly', () => {
        ...
        expect(logo).toHaveAttribute('src', '/src/assets/images/icons/logo-white.png');

        const mobileLogo = screen.getByTestId('header-mobile-logo');
        expect(mobileLogo).toHaveAttribute('src', '/src/assets/images/icons/mobile-logo-white.png');
